...
export default class Authenticity_Certificate extends Documents{
    ...
    constructor(scene, x, y, sName, sExpirationD, sPhoto, sCreationD, sSerialNumber){
		...
		//color texto: #896789
		//texto del nombre
		this._sNametext = this.scene.add.bitmapText(-58, -35, 'generalFont', this._sName, this.fontsize);
		...
		this._sSerialNumbertext = this.scene.add.bitmapText(-58, 9, 'generalFont', this._sSerialNumber);
